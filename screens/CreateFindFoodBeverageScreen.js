...
const CreateFindFoodBeverageScreen = props => {
  const { theme } = props;
    ...
    >
      ...
      >
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFood1TakeawayScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFood2BeverageScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFood3ResturantScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFood4BarScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFood5CafeScreen');
            } catch (err) {
              console.error(err);
            }
          }}
...
export default withTheme(CreateFindFoodBeverageScreen);
