...
const CreateFindAccommodationScreen = props => {
  const { theme } = props;
    ...
    >
      ...
      >
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateAccommodationhotelScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateAcc4CampingScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFindAcc5RentaroomScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFindAcc7ApartmentScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFindAcc6HouseScreen');
            } catch (err) {
              console.error(err);
            }
          }}
...
const styles = theme =>
  StyleSheet.create({
    Button2fc5eefb: {
      backgroundColor: theme.colors['Custom #6174f6'],
...
export default withTheme(CreateFindAccommodationScreen);
