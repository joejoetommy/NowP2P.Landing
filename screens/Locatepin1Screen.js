...
const Locatepin1Screen = props => {
  ...
  React.useEffect(() => {
    ...
    try {
      ...
      console.log('Start ON_SCREEN_FOCUS:0 NAVIGATE_SCREEN');
      navigation.navigate('Step3PayPinitScreen');
      console.log('Complete ON_SCREEN_FOCUS:0 NAVIGATE_SCREEN');
    } catch (err) {
      console.error(err);
  ...
  const mapViewdDEp3UENRef = React.useRef();
...
export default withTheme(Locatepin1Screen);
