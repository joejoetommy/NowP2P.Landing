...
const FeedFindPinScreen = props => {
  ...
  const mapViewqz6kjRlZRef = React.useRef();
  ...
  return (
    ...
    >
      ...
      <View style={styles(theme).View02a568ec}></View>
      {/* Scroll Content View */}
      <ScrollView
...
const styles = theme =>
  StyleSheet.create({
    ...
    View25d1e709: { maxHeight: 45 },
    View2a2749f9: { paddingBottom: 7, paddingTop: 7 },
    View31737319: {
      borderBottomWidth: 1,
      borderColor: theme.colors['Community_Medium_Black'],
      borderLeftWidth: 1,
      borderRightWidth: 1,
      borderTopWidth: 1,
    },
