...
const CreateFindDropoffScreen = props => {
  const { theme } = props;
    ...
    >
      ...
      >
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateDropOff1privateDriverScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateDropOff2DeliveryScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateDropOff3FooddeliveryScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateDropOff4FreightdeliveryScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateDropOff5RideShareScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateDropOff6TransportationScreen');
            } catch (err) {
              console.error(err);
            }
          }}
...
export default withTheme(CreateFindDropoffScreen);
