...
const CreateFoodBeverageMakeorderScreen = props => {
  const { theme } = props;
...
const styles = theme =>
  StyleSheet.create({
    ...
    Buttona3550a26: { height: 5, marginBottom: 5 },
...
export default withTheme(CreateFoodBeverageMakeorderScreen);
