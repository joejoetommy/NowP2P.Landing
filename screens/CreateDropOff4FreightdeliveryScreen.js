...
const CreateDropOff4FreightdeliveryScreen = props => {
  const { theme } = props;
  ...
  const mapViewnNjioFWyRef = React.useRef();
      ...
      <View style={styles(theme).View44cd555e}>
        ...
        >
          <TextInput
            ...
            style={styles(theme).TextInput3aede295}
            placeholder={'Vehicle size required'}
            placeholderTextColor={theme.colors.textPlaceholder}
            multiline={true}
          />
        </View>
...
export default withTheme(CreateDropOff4FreightdeliveryScreen);
