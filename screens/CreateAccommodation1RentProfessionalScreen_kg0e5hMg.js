...
const CreateAccommodation1RentProfessionalScreen_kg0e5hMg = props => {
  const { theme } = props;
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Category */}
        <View style={GlobalStyles.ViewStyles(theme)['contract term']}>
          <TextInput
            onChangeText={newTextInputValue => {
              try {
                setTextInputValue(newTextInputValue);
...
export default withTheme(CreateAccommodation1RentProfessionalScreen_kg0e5hMg);
