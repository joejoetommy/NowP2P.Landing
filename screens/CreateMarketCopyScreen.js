...
const CreateMarketCopyScreen = props => {
  const { theme } = props;
    ...
    >
      ...
      >
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFindAccommodationScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFindBuySellScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFindDropoffScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFindAppointmentsBookingScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFindWorkScreen');
            } catch (err) {
              console.error(err);
            }
          }}
          ...
          title={'Work / Contracting'}
        />
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFindFoodBeverageScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFindOtherMarketScreen');
            } catch (err) {
              console.error(err);
            }
          }}
...
export default withTheme(CreateMarketCopyScreen);
