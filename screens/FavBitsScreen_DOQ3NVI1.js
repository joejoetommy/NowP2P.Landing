...
const FavBitsScreen_DOQ3NVI1 = props => {
  const { theme } = props;
  ...
  const mapViewA2sHSiYlRef = React.useRef();
  ...
  return (
    ...
    >
      ...
      <View style={styles(theme).View404f027f}>
        ...
        <Text style={styles(theme).Text7b0e5938}>{'Fav. Bits'}</Text>
      </View>
                              ...
                              <View
                                style={[
                                  GlobalStyles.ViewStyles(theme)[
                                    'Token business card 6'
                                  ],
                                  styles(theme).Viewfbc0413d,
                                ]}
                              >
                                <Image
                                ...
                                <View style={styles(theme).Viewb3d565fb}>
                                  ...
                                  <View style={styles(theme).View79351d85}>
                                    ...
                                    />
                                    <Text style={styles(theme).Text4ce026e8}>
                                      {'33'}
                                    </Text>
                                    <Icon
                                      ...
                                      name={'Ionicons/heart'}
                                    />
                                    <Text style={styles(theme).Textc8e26ead}>
                                      {'112'}
                                    </Text>
                                    <Icon
                                      style={styles(theme).Icond51c0199}
...
const styles = theme =>
  StyleSheet.create({
    ...
    Viewfbc0413d: {
      borderBottomWidth: 1,
      borderColor: theme.colors['Community_Icon_Fill'],
      borderLeftWidth: 1,
      borderRightWidth: 1,
      borderTopWidth: 1,
      marginBottom: 1,
...
export default withTheme(FavBitsScreen_DOQ3NVI1);
