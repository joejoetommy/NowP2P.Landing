...
const CreateFindScreen_cqvrEKO9 = props => {
  const { theme } = props;
    ...
    >
      ...
      >
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateMarketCopyScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('FindMarketScreen');
            } catch (err) {
              console.error(err);
            }
          }}
...
export default withTheme(CreateFindScreen_cqvrEKO9);
