...
const CreateFindWorkScreen = props => {
  const { theme } = props;
    ...
    >
      ...
      >
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFindWorkProfoptScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateFindWorktaskoptScreen');
            } catch (err) {
              console.error(err);
            }
          }}
...
export default withTheme(CreateFindWorkScreen);
