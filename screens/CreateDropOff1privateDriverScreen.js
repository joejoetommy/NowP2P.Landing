...
const CreateDropOff1privateDriverScreen = props => {
  const { theme } = props;
  ...
  const mapViewwiKzwp4jRef = React.useRef();
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        style={styles(theme).Buttonc7c35391}
...
export default withTheme(CreateDropOff1privateDriverScreen);
