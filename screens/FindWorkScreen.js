    ...
    >
      ...
      >
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('FindWorkProfoptCopyScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('FindWorktaskoptCopyScreen');
            } catch (err) {
              console.error(err);
            }
          }}
...
export default withTheme(FindWorkScreen);
