...
const CreateFindWorkProfoptScreen = props => {
  const { theme } = props;
    ...
    >
      ...
      >
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateWorkprof1adminScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateWorkprof2FarmingScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateWorkprof3BuildingScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateWorkprof4CreativeScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateWorkprof5ITScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateWorkprof6MechanicalScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateWorkprof7TransportScreen');
            } catch (err) {
              console.error(err);
            }
          }}
        ...
        <Button
          onPress={() => {
            try {
              navigation.navigate('CreateWorkprof8OtherScreen');
            } catch (err) {
              console.error(err);
            }
          }}
...
export default withTheme(CreateFindWorkProfoptScreen);
