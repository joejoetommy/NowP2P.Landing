...
const CreateDropOff6TransportationScreen = props => {
  const { theme } = props;
  ...
  const mapViewbe1lAn9oRef = React.useRef();
  ...
  return (
    ...
    >
      ...
      <View style={styles(theme).View44cd555e}>
        ...
        <Text style={styles(theme).Texte576ac7e}>{'Available Seats '}</Text>
        <NumberInput
        ...
        <View style={styles(theme).Viewc22dd40d}>
          <Text style={styles(theme).Texte576ac7e}>
        ...
        <Text style={styles(theme).Texte576ac7e}>{'Transport Vehicle'}</Text>
        {/* Add description */}
        <View
          style={GlobalStyles.ViewStyles(theme)['add description']}
          accessibilityRole={'text'}
        >
          <TextInput
            ...
            style={styles(theme).TextInput3aede295}
            placeholder={'Add details of the vehicle'}
            placeholderTextColor={theme.colors.textPlaceholder}
            multiline={true}
          />
        </View>
...
export default withTheme(CreateDropOff6TransportationScreen);
